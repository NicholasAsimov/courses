...
def getWordScore(word, n):
    ...
    # Add bonus points for using every letter
    if len(word) == n:
        wordScore += 50
...
def updateHand(hand, word):
    ...
    for ch in word:
        if ch in newHand.keys():
            newHand[ch] = newHand.get(ch) - 1
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Ask user for input
        userInput = raw_input("Enter word, or a \".\" to indicate that you are finished: ").lower()
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                wordScored = getWordScore(userInput, n)
                score += wordScored
                print "{} earned {} points. Total: {} points\n".format(userInput, wordScored, score)
                # Update the hand
