...
adopter = MedicatedAllergicAdopter("O", "Cat", ['Dog', 'Horse'], {"Dog": .5, "Horse": 0.2})
adopter2 = Adopter("X", "Cat")
adopter3 = FlexibleAdopter("D", "Horse", ["Lizard", "Cat"])
adopter4 = FearfulAdopter("P","Cat","Dog")
adopter5 = SluggishAdopter("Z","Cat", (1,2))
adopter6 = AllergicAdopter("A", "Cat", "Dog")
...
print "get_adopters_for_advertisement", get_adopters_for_advertisement(ac2, [adopter, adopter2, adopter3, adopter4, adopter5, adopter6], 10)
#for el in get_adopters_for_advertisement(ac2, [adopter, adopter2, adopter3, adopter4, adopter5, adopter6], 10):
#    print "{} : {}".format(el[0].get_name(), el[1])
...
print "\nget_ordered_adoption_center_list", get_ordered_adoption_center_list(adopter4, [ac,ac2,ac3,ac4,ac5,ac6])
#for el in get_ordered_adoption_center_list(adopter4, [ac,ac2,ac3,ac4,ac5,ac6]):
#    print el[0].get_name(), ':', el[1]
