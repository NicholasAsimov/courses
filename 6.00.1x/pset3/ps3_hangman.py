...
def isWordGuessed(secretWord, lettersGuessed):
    ...
    returns: bool, True if all the letters of secretWord are in lettersGuessed;
      False otherwise
    '''
...
def getAvailableLetters(lettersGuessed):
    ...
    for ch in lettersGuessed:
        if ch in available_letters:
            available_letters = available_letters.replace(ch, '')
...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the
    ...
    print "Welcome to the game, Hangman!\nI am thinking of a word " \
        "that is {} letters long.".format(len(secretWord))
    print "-------------"
